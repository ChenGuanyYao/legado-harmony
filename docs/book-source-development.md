...
> 适用版本：`3.7.832`（2026-08-24）。本文以当前工作区代码为准；规则能力、字段消费方式和限制可能随版本继续调整。
...
| --- | --- |
| 适用项目 | `legado-harmony` |
| 适用版本 | `3.7.832`（以 `AppScope/app.json5` 为准） |
| 最后核对 | 2026-08-24 |
...
| 朗读一直念星号、井号或与号 | 当前版本会过滤只由常见装饰符组成的整行；若符号与推广文字混在同一行，使用 `replaceRegex` 精确清理该站文本，避免扩大通用过滤误删正常正文。 |
