...
- 支持浅色/深色模式。
- 支持经典蓝、暖纸、林雾、水墨、霓虹、草莓奶霜、赤墨档案、梅影茶烟、玫瑰来信、月鹤星河等主题包，统一 App 字体、语义色、阅读背景、正则气泡、圆角、玻璃材质与悬浮底栏图标。
- 支持按钮色、强调色的主题级默认值与用户微调。
- 正则字体支持跟随主题、文字强调、高亮色块，以及 QQ 柔和、QQ 实色、胶囊、纸笺、霓虹和十套主题专属强调样式；局部与整段命中统一使用带主题镜像端饰的行内装饰框。
